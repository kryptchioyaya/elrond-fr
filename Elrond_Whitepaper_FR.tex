...
\begin{figure}
	\includegraphics[width=\linewidth]{./images/Fig1_Page1.jpg} % Figure image
...
\begin{figure}
	\includegraphics[width=\linewidth]{./images/Fig2} % Figure image
...
\begin{figure}
	\includegraphics[width=\linewidth]{./images/Fig3} % Figure image
...
\begin{figure*}[h]
         \centering
	\includegraphics[width=\linewidth]{./images/Fig4} % Figure image
...
\begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig5} % Figure image
...
\begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig6} % Figure image
...
\begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig7} % Figure image
...
Il existe déjà plusieurs langages de contrats intelligents spécifiés dans le Framework K, ou dont les spécifications sont en cours d'élaboration. Le réseau Elrond prendra en charge trois langages de bas niveau : IELE VM, KEVM et WASM.
 ...
 \begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig8} % Figure image
...
\begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig9} % Figure image
	\caption{Exécution de la Machine Virtuelle (VM) Elrond} % Figure caption
...
\begin{figure*}[h]
         \centering
	\includegraphics[width=\linewidth]{./images/Fig10} % Figure image
...
\begin{figure*}[h]
         \centering
	\includegraphics[width=\linewidth]{./images/Fig11} % Figure image
...
\begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig13} % Figure image
	\caption{Débit des transactions} % Figure caption
	\label{Fig.13} % Label for referencing with \ref{}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=\linewidth]{./images/Fig14} % Figure image
...
\begin{figure*}[h]
         \centering
	\includegraphics[width=\linewidth]{./images/Fig12} % Figure image
